...
ENV NEXT_PUBLIC_FAHEM_API_URL=http://localhost/api/v1/
ENV NEXT_PUBLIC_FAHEM_BACKEND_URL=http://localhost/
ENV NEXT_PUBLIC_FAHEM_DOMAIN=localhost
ENV NEXT_PUBLIC_FAHEM_COLLABORATION_WS_URL=ws://localhost:1998
...
ENV PORT=8000 FAHEM_PORT=9000 HOSTNAME=0.0.0.0
