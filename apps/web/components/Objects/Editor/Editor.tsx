...
import fahemIcon from 'public/fahem_icon.png'
import { ToolbarButtons } from './Toolbar/ToolbarButtons'
import { motion } from 'framer-motion'
import Image from 'next/image'
import styled from 'styled-components'
import { DividerVerticalIcon, SlashIcon } from '@radix-ui/react-icons'
import fahemAI_icon from 'public/fahem_ai_simple.png'
import {
  AIEditorStateTypes,
  useAIEditor,
  useAIEditorDispatch,
...
//..todo
const EditorInfoFahemLmsLogo = styled(Image)`
  border-radius: 6px;
  margin-right: 0px;
`
